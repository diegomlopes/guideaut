...
import 'package:guideaut/features/auth/domain/usecases/signup.dart';
import 'package:guideaut/features/auth/presentation/sign_up_template.dart';
...
class _FormSignUpState extends State<FormSignUp> {
        ...
        child: Responsive(children: <Widget>[
          ...
          Div(
            ...
            child: FormBackground(
                title: AppLocalizations.of(context)!.new_user.toUpperCase(),
                child: AFWidget<SignUpTemplate>(
                  handleErrorOnSubmit: print,
                  formBuilder: () => SignUpTemplate(),
                  ...
                  onSubmitted: (SignUpTemplate form) async {
  ...
  Future<void> showPopupError() async {
    await showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(AppLocalizations.of(context)!.invalid_new_user_data),
          actions: [
            TextButton(
              onPressed: () {
